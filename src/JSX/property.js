function ItemProperty(props) {
    return (
        <div className="w-[25%] shadow-lg cursor-pointer hover:shadow-2xl rounded-lg absolute top-0 h-[100%] px-1">
            ...
            <section name="property" className="pt-5">
                ...
                <div className="property-container mt-5 relative overflow-hidden">
                    ...
                    <div id="property-container-sliderBtn" className="">
                        <button onClick={() => slideLeft()} className="absolute left-0 z-10 top-[25%] bg-red-700 shadow-2xl p-2 text-white text-2xl">&larr;</button>
                        <button onClick={() => slideRight()} className="absolute right-0 z-10 top-[25%] bg-red-700 shadow-2xl p-2 text-white text-2xl">&rarr;</button>
                    </div>
                </div>
            </section>
        </>
...
var [translateX, maxTranslateX, minTranslateX] = [0, (properties.length - 4) * 25, (properties.length - 4) * 25 * -1];

console.log(maxTranslateX);
console.log(minTranslateX);

window.onload = function () {
    propertyContainerWrapper = document.querySelector('.property-container-wrapper');
