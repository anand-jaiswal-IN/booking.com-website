...
function Offers() {
  return (
    <section name="offers" className="md:mt-32 mt-5">
      <h1 className="text-2xl font-bold">Offers</h1>
      <p>
        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dicta, facere!
      </p>
      <div className="offers-container md:flex justify-center content-center mt-5">
        <div className="flex items-center rounded-md md:w-[50%] p-3">
          <div>
            <img
